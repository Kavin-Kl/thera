const require_chunk = require("./chunk-BxqGC3qT.js");
const require_from = require("./from-JveeB_lb.js");
let node_stream = require("node:stream");
node_stream = require_chunk.__toESM(node_stream, 1);
let node_http = require("node:http");
node_http = require_chunk.__toESM(node_http, 1);
let node_https = require("node:https");
node_https = require_chunk.__toESM(node_https, 1);
let node_zlib = require("node:zlib");
node_zlib = require_chunk.__toESM(node_zlib, 1);
...
var init_dist = require_chunk.__esmMin((() => {}));
//#endregion
//#region node_modules/node-fetch/src/errors/base.js
var FetchBaseError;
var init_base = require_chunk.__esmMin((() => {
...
var FetchError;
var init_fetch_error = require_chunk.__esmMin((() => {
	init_base();
...
var init_is = require_chunk.__esmMin((() => {
...
var init_body = require_chunk.__esmMin((() => {
	require_from.init_fetch_blob();
	...
	Body = class {
		...
		*/
		...
		async formData() {
			...
			const { toFormData } = await Promise.resolve().then(() => require("./multipart-parser-1Nb1S371.js"));
...
var init_headers = require_chunk.__esmMin((() => {
...
var init_is_redirect = require_chunk.__esmMin((() => {
...
var init_response = require_chunk.__esmMin((() => {
	init_headers();
	init_body();
	init_is_redirect();
...
var getSearch;
var init_get_search = require_chunk.__esmMin((() => {
	getSearch = (parsedURL) => {
...
var init_referrer = require_chunk.__esmMin((() => {
...
var init_request = require_chunk.__esmMin((() => {
	init_headers();
	init_body();
	init_is();
	init_get_search();
...
var AbortError;
var init_abort_error = require_chunk.__esmMin((() => {
	init_base();
